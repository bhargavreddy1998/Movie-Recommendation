...
public class ShowGen {
	...
	public ShowGen(String s,boolean i,boolean b)
	{
		gen=s;
		imdb=i;
		box=b;
	...
	protected void createContents() {
		...
		String qry="select id,title,genre,year,imdb,box_office from film where genre='"+gen+"' order by ";
		if(imdb)
			qry+="imdb";
		else
			qry+="box_office";
