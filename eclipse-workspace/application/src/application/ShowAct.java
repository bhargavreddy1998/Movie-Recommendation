...
public class ShowAct {
	...
	public ShowAct(String s,boolean i,boolean b)
	{
		gen=s;
		imdb=i;
		box=b;
	...
	protected void createContents() {
		...
		shell.setText("Appearance By-"+gen);
		...
		String qry="select id,title,genre,year,imdb,box_office from film natural join film_cast where lead_actor='"+gen+"' or lead_actress='"+gen+"' or supp_actor='"+gen+"' or supp_actress='"+gen+"' order by ";
		if(imdb)
			qry+="imdb";
		else
			qry+="box_office";
